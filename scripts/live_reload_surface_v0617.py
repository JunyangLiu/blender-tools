"""Checkpoint the active scene and reload component-isolated flatten v0.6.17."""
...
CHECKPOINT = (
    r"C:\codex_auto\semantic_mesh_restorer_maus_turret"
    r"\maus_turret_before_flatten_component_safety_v0617.blend"
)
...
def probe():
    ...
    return {
        ...
        "source_visible": bool(
            source and source.visible_get(view_layer=bpy.context.view_layer)
        ),
...
if tuple(addon.bl_info["version"]) != (0, 6, 17):
    raise RuntimeError("Unexpected add-on version: " + repr(addon.bl_info["version"]))
print("SMRN_SURFACE_RELOAD_V0617=" + json.dumps({
