"""Reload v0.5.3 in the isolated Maus Blender without touching model geometry."""
...
scene.smrn_surface_height_mode = "MEDIAN"
scene.smrn_surface_normal_mode = "AUTO"
scene.smrn_status = "刷选可拖动；平整高度和法向可分别指定。候选通过检查前不会替换原网面。"
