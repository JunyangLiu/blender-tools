"""Checkpoint the active Maus scene and reload surface-island compatibility v0.6.16."""
...
CHECKPOINT = (
    ...
    r"\maus_turret_before_flatten_island_v0616.blend"
)
...
if tuple(addon.bl_info["version"]) != (0, 6, 16):
    raise RuntimeError("Unexpected add-on version: " + repr(addon.bl_info["version"]))
print("SMRN_SURFACE_RELOAD_V0616=" + json.dumps({
