"""Hot-reload v0.6.25 while proving source and semantic marks are preserved."""
...
if tuple(addon.bl_info["version"]) != (0, 6, 25):
    raise RuntimeError("Unexpected add-on version: " + repr(addon.bl_info["version"]))
print("SMRN_ROTATIONAL_RELOAD_V0625=" + json.dumps({
