"""Reload v0.6.6 in the isolated Maus Blender and prove scene preservation."""
...
def scene_probe(package):
    ...
    return {
        ...
        "marks": storage.document_summary(scene)["mark_count"],
...
print("SMRN_SURFACE_RELOAD_V066=" + json.dumps({
