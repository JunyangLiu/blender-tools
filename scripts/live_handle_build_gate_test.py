"""Verify invalid live marks cannot mutate the Maus source or make a candidate."""
...
result = sorted(bpy.ops.smrn.build_handle_candidate())
...
print("SMRN_HANDLE_BUILD_GATE=" + json.dumps({
    ...
    "summary": scene.smrn_handle_summary,
