"""Reload v0.6.5 in the isolated Maus Blender without changing scene geometry."""
...
print("SMRN_SURFACE_RELOAD_V065=" + json.dumps({
    "addon_version": list(addon.bl_info["version"]),
    "blend": bpy.data.filepath,
    "source": str(bpy.context.scene.get("smrn_source_name", "")),
