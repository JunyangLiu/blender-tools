...
class ProjectContractTests(unittest.TestCase):
    ...
    def test_local_surface_rebuild_is_feature_locked_and_recoverable(self):
        ...
        self.assertIn('"progress_metric_scope": "supported_components_editable_green_interior_vertices"', adapter)
        self.assertIn('"preservation_policy": "keep_low_support_components_unchanged_v1"', adapter)
        self.assertIn('core_movable = list(moved_vertices)', adapter)
