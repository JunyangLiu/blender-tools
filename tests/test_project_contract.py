...
class ProjectContractTests(unittest.TestCase):
    ...
    def test_local_surface_rebuild_is_feature_locked_and_recoverable(self):
        ...
        self.assertIn('"unmarked_vertices_moved": 0', adapter)
        self.assertIn('MIN_FLATTEN_INTERIOR_SUPPORT = 3', adapter)
        self.assertIn('RELIABLE_COMPONENT_DIHEDRAL_SAMPLE = 32', adapter)
        self.assertIn("def _flatten_component_safe_fraction", adapter)
        self.assertIn('"method": "component_independent_safe_projection_v2"', adapter)
        self.assertIn('"progress_metric_scope": "accepted_components_editable_green_interior_vertices"', adapter)
        self.assertIn('"preservation_policy": "component_independent_safety_preservation_v2"', adapter)
        self.assertIn('"component_safety_passed"', adapter)
        ...
        self.assertIn("fraction >= 0.5", adapter)
        self.assertIn('quality_gates["matched_dihedral_within_limit"] = bool(', adapter)
        ...
        self.assertIn("component_independent_safe_projection_v2", adapter)
