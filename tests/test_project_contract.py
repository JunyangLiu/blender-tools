...
class ProjectContractTests(unittest.TestCase):
    ...
    def test_local_surface_rebuild_is_feature_locked_and_recoverable(self):
        ...
        self.assertIn('canvas_macro_folds if mode == "canvas"', adapter)
        ...
        self.assertIn('"canvas_pipeline": "fair_base_then_source_aligned_wave_outer_envelope_v3"', adapter)
        ...
        self.assertIn('polygon.use_smooth = True', adapter)
