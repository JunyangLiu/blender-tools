...
class ProjectContractTests(unittest.TestCase):
    ...
    def test_disconnected_rotational_marks_require_local_geometric_proof(self):
        ...
        self.assertIn('"axis_acceptance_mode": acceptance_mode', adapter)
        self.assertIn("coherent_broad_side_normals", adapter)
        self.assertIn("span >= math.radians(240.0)", adapter)
        self.assertIn("separation >= radial_scale * 0.35", adapter)
        self.assertNotIn("source_normals or ()", adapter)
        self.assertIn('"method": "normal_null_axis_projected_source_envelope_rings"', adapter)
        self.assertIn("coherent_source_face_centers_and_normals", adapter)
        self.assertIn("fit_rotational_surface_fixed_axis", adapter)
        self.assertIn("compatible_face_indices", adapter)
