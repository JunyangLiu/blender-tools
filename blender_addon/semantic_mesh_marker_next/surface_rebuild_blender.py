...
def _rebuild_working_mesh(
    ...
    ] if mode in {"canvas", "canvas_physics"} else []
    ...
    if mode in {"canvas", "canvas_physics"} and not movable:
        bm.free()
        _remove_object(working)
    ...
    if mode == "rotational" and movable:
        ...
        safe_fraction, safety_attempts = _canvas_safe_fraction(
            bm,
            movable,
            before_coordinates,
            proposed_coordinates,
    ...
    report = {
        ...
        "automatic_canvas_subdivision": mode in {"canvas", "canvas_physics"},
